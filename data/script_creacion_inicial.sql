...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[UsuarioRol]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[UsuarioRol]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[FuncPorRol]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[FuncPorRol]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Funcionalidad]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Funcionalidad]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Rol]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Rol]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Usuario]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Usuario]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Cliente]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Cliente]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Devolucion]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Devolucion]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Direccion]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Direccion]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Empresa]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Empresa]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Factura]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Factura]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[FormaPago]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[FormaPago]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[HistoricoPago]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[HistoricoPago]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[ItemFactura]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[ItemFactura]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Pago]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Pago]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Rendicion]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Rendicion]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Rubro]')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Rubro]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = '[MIRRORING_GUYS].[Sucursal]')
BEGIN
