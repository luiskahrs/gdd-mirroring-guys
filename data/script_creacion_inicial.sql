...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'UsuarioSucursal')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[UsuarioSucursal]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'UsuarioRol')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[UsuarioRol]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'FuncPorRol')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[FuncPorRol]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Funcionalidad')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Funcionalidad]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Rol')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Rol]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Usuario')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Usuario]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Devolucion')
BEGIN
...
IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'HistoricoPago')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[HistoricoPago]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'ItemFactura')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[ItemFactura]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Factura')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Factura]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Rendicion')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Rendicion]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Pago')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Pago]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Empresa')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Empresa]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Rubro')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Rubro]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Sucursal')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Sucursal]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'FormaPago')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[FormaPago]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Cliente')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Cliente]
END
GO

IF EXISTS (SELECT * FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = 'MIRRORING_GUYS' AND  TABLE_NAME = 'Direccion')
BEGIN
   DROP TABLE [MIRRORING_GUYS].[Direccion]
END
GO

IF EXISTS (SELECT * FROM sysobjects WHERE  id = object_id(N'[MIRRORING_GUYS].[Usuario_Login]') and OBJECTPROPERTY(id, N'IsProcedure') = 1 )
BEGIN
	DROP PROCEDURE [MIRRORING_GUYS].[Usuario_Login]
END
GO

IF NOT EXISTS (select * from sys.database_principals where name = 'gd')
BEGIN
...
CREATE TABLE MIRRORING_GUYS.UsuarioSucursal (
	id						INT	IDENTITY(1,1) NOT NULL,
	id_usuario				INT NOT NULL,
...
ALTER TABLE [MIRRORING_GUYS].[UsuarioSucursal]  WITH CHECK ADD  CONSTRAINT [FK_UsuarioSucursal_Usuario] FOREIGN KEY([id_usuario])
REFERENCES [MIRRORING_GUYS].[Usuario] ([id])
GO
ALTER TABLE [MIRRORING_GUYS].[UsuarioSucursal] CHECK CONSTRAINT [FK_UsuarioSucursal_Usuario]
GO

ALTER TABLE [MIRRORING_GUYS].[UsuarioSucursal]  WITH CHECK ADD  CONSTRAINT [FK_UsuarioSucursal_Sucursal] FOREIGN KEY([id_sucursal])
REFERENCES [MIRRORING_GUYS].[Sucursal] ([id])
GO
ALTER TABLE [MIRRORING_GUYS].[UsuarioSucursal] CHECK CONSTRAINT [FK_UsuarioSucursal_Sucursal]
GO
...
ALTER TABLE [MIRRORING_GUYS].[ItemFactura] WITH CHECK ADD FOREIGN KEY(id_factura) REFERENCES [MIRRORING_GUYS].[Factura](id)
...
INSERT INTO MIRRORING_GUYS.Direccion(calle, codigo_postal)
...
WHERE m.Cliente_Codigo_Postal = d.codigo_postal AND m.Cliente_Direccion = d.calle
GO
...
WHERE m.Empresa_Direccion = d.calle AND m.Rubro_Descripcion = r.descripcion
GO
